...
/**
 * Predicates to use with Streams of StringPredicates. Some of these seem pointless as they are
 * aliases to existing Java methods that you can pass as a method reference. Their real power comes
 * out when used with the fluent composition methods of predicates (such as: or, and, negate).
 * Filtering a stream of StringPredicates to those that are nonNull and nonEmpty can look like this:
 *
 * <pre>{@code
 * // with this library
...
public final class StringPredicates {
  ...
  /**
   * Predicate to check that a string is longer than a given length, exclusive of the bound.
   *
  ...
  /**
   * Predicate to check that a string is shorter than a given length, exclusive of the bound.
   *
   * @param length the bound for length
   * @return A predicate that returns true when a given string's length &lt; length
   * @see String#length()
  ...
  /**
   * Predicate to check that a string equals a given value using Objects.equals. Under this method
   * contract only a null will equal another null, otherwise the strings must match exactly
   * according to the normal contract of String.equals.
   *
   * @param match A string to match against
   * @return A predicate that returns true when a given string equals the match
   * @see Objects#equals(Object, Object)
   */
  public static Predicate<String> equal(String match) {
    return s -> Objects.equals(s, match);
  }

  /**
   * A predicate that returns true if and only if a given string contains the specified sequence of
   * char values.
   *
   * @param sub the subsequence to search for
   * @return A predicate that returns true if and only if a given string contains the specified
   ...
   * @return a predicate that tells whether or not a given string matches the given regular
   *     expression
  ...
  /**
   * Predicate to check that a string equals a given value using String.equalsIgnoreCase. Under this
   * method contract only a null will equal another null, otherwise the strings must match exactly
   * according to the normal contract of String.equals.
   *
   * @param match A string to match against
   * @return A predicate that returns true when a given string equals the match
  ...
  /**
   * A predicate that returns true if and only if a given string contains the specified sequence of
   * char values, ignoring case.
   *
   * @param sub the subsequence to search for
   * @return A predicate that returns true if and only if a given string contains the specified
   *     sequence of char values, ignoring case.
   * @see String#equalsIgnoreCase(String)
   */
